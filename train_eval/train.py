...
parser.add_argument('--model', default='pointcnn', help='Model name [default: frustum_pointnets_v1]')
...
def train():
    ...
    with tf.Graph().as_default():
        with tf.device('/gpu:'+str(GPU_INDEX)):
            pointclouds_pl, one_hot_vec_pl, features_pl, labels_pl, centers_pl, \
            ...
            end_points = MODEL.get_model(pointclouds_pl, features_pl, one_hot_vec_pl,
        ...
        if FLAGS.restore_model_path is None:
            ...
            sess.run(init)
            #sess = tf_dbg.LocalCLIDebugWrapperSession(sess)  # debug
        else:
...
def train_one_epoch(sess, ops, train_writer):
    ...
    for batch_idx in range(num_batches):
        ...
        batch_data, batch_label, batch_center, batch_features, \
        ...
        feed_dict = {ops['pointclouds_pl']: batch_data,
                     ops['features_pl']: batch_features,
