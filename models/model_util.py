...
def placeholder_inputs(batch_size, num_point):
    ...
    features_pl = tf.placeholder(tf.float32, shape=None)
    ...
    return pointclouds_pl, one_hot_vec_pl, features_pl, labels_pl, centers_pl, \
...
def get_center_regression_net(object_point_cloud, one_hot_vec,
    ...
    #print("center regression net 1:",net)
...
def get_loss(mask_label, center_label, \
    ...
    #mask_loss = tf.Print(mask_loss, ['mask loss: ', mask_loss])
    ...
    #stage1_center_loss = tf.Print(stage1_center_loss, ['center regression losses: ', stage1_center_loss])
    ...
    #heading_class_loss = tf.Print(heading_class_loss, ['heading class loss: ', heading_class_loss])
    ...
    #heading_residual_normalized_loss = tf.Print(heading_residual_normalized_loss,
    #                                            ['heading residual normalized loss: ',
    ...
    #size_class_loss = tf.Print(size_class_loss, ['size class loss: ', size_class_loss])
    ...
    #size_residual_normalized_loss = tf.Print(size_residual_normalized_loss,
    #                                         ['size residual normalized loss: ',
    ...
    #corners_loss = tf.Print(corners_loss, ['corner loss: ', corners_loss])
